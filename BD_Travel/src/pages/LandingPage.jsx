...
export default function LandingPage() {
  ...
  useEffect(()=>{
     fetch('http://scriptsurgeons.pythonanywhere.com/api/hotels/?format=json')
  ...
  const topDeals = posts.filter((post) => post.top_deal); 

  return (
    <div className="space-y-4">
      <div className="min-h-[20vh] mt-[40px]">
      <NavButton />
      </div>
      <h1 className="text-3xl font-bold text-center my-4">Top Hotels</h1>
      <div className="grid grid-cols-3 min-h-[30vh] max-w-[95%] mx-auto">
        {
          loading?
      ...
      <div className="grid grid-cols-3 min-h-[30vh]">
      {
          loading?
          <div className="h-screen w-screen justify-center fixed text-center"> 
              <span className="loading loading-bars loading-lg"></span>
